 ...
 *
 */
package net.mcreator.animalexpansion;
...
@Mod("animal_expansion")
public class AnimalExpansionMod {
	public static final Logger LOGGER = LogManager.getLogger(AnimalExpansionMod.class);
	public static final String MODID = "animal_expansion";
